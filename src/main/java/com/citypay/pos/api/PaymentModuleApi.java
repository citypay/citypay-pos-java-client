...
import com.citypay.pos.ApiCallback;
import com.citypay.pos.ApiClient;
import com.citypay.pos.ApiException;
import com.citypay.pos.ApiResponse;
import com.citypay.pos.Configuration;
import com.citypay.pos.Pair;
import com.citypay.pos.ProgressRequestBody;
import com.citypay.pos.ProgressResponseBody;
...
public class PaymentModuleApi {
     ...
     */
    public com.squareup.okhttp.Call receiptCall(TransactionProgress body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call receiptValidateBeforeCall(TransactionProgress body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public TransactionResult receipt(TransactionProgress body) throws ApiException {
        ApiResponse<TransactionResult> resp = receiptWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TransactionResult> receiptWithHttpInfo(TransactionProgress body) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call receiptAsync(TransactionProgress body, final ApiCallback<TransactionResult> callback) throws ApiException {
